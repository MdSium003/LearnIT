...
CREATE TABLE "Sub_Topic" (
  "Sub_Topic_ID" INTEGER UNIQUE,
  "Course_ID" INTEGER,
  "Teacher_ID" INTEGER NOT NULL,
  "Problem_Set_ID" INTEGER UNIQUE,
  "Title" VARCHAR(255) NOT NULL,
  "Is_one_video" BOOLEAN,
  PRIMARY KEY ("Sub_Topic_ID", "Course_ID"),
...
ALTER TABLE "Video" ADD CONSTRAINT fk_video_subtopic
  FOREIGN KEY ("Sub_Topic_ID", "Course_ID") REFERENCES "Sub_Topic" ("Sub_Topic_ID", "Course_ID");
...
ALTER TABLE "Sub_Topic" ADD CONSTRAINT fk_subtopic_teacher
  FOREIGN KEY ("Teacher_ID") REFERENCES "Teacher" ("Teacher_ID");
...
CREATE TABLE "Assignment" (
  ...
  PRIMARY KEY ("Assignment_ID", "Sub_Topic_ID"),
...
CREATE TABLE "Exam" (
  ...
  PRIMARY KEY ("Sub_Topic_ID", "Exam_ID"),
  FOREIGN KEY ("Sub_Topic_ID") REFERENCES "Sub_Topic" ("Sub_Topic_ID")
);
...
CREATE TABLE "Mark" (
  ...
  "Exam_Mark" INTEGER,
  PRIMARY KEY ("Student_ID", "Course_ID", "Sub_Topic_ID"),
